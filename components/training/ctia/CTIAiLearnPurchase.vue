        ...
        <v-card class="secondary--text text-xs-center py-3 elevation-12">
          <v-layout row wrap justify-center align-center>
            ...
            <v-flex xs12 lg6 px-4>
              <h2 class="display-1 secondary--text mt-4">CTIA Self-Paced (iLearn)</h2>
              <p class="display-1 primary--text mt-3 mb-4">$1,199</p>
                ...
                <v-layout wrap justify-center align-center>
                  <v-flex xs12 sm10>
                    ...
                    <v-btn
                      ...
                      data-item-id="019"
                      data-item-name="CTIA Self-Paced (iLearn)"
                      data-item-price="1199.00"
                      data-item-image="https://res.cloudinary.com/missionwebdev/image/upload/f_auto/v1557000843/StealthEntry/eccouncil/CTIA-Main-Cover.jpg"
                      data-item-url="/products.json"
                      data-item-description="CTIA is designed and developed in collaboration with cybersecurity and threat intelligence experts across the globe to help organizations identify and mitigate business risks by converting unknown internal and external threats into known threats."
                    >Add to Cart</v-btn>
                  </v-flex>
                </v-layout>
              </v-container>
