        ...
        <v-card class="secondary--text text-xs-center py-3 elevation-12">
          <v-layout row wrap justify-center align-center>
            ...
            <v-flex xs12 lg6 px-4>
              <h2 class="display-1 secondary--text mt-4">CHFI Self-Paced (iLearn)</h2>
                ...
                <v-layout wrap justify-center align-center>
                  <v-flex xs12 sm10>
                    ...
                    <v-btn
                      ...
                      data-item-id="010"
                      data-item-name="CHFI Self-Paced (iLearn)"
                      data-item-price="1899.00"
                      data-item-image="https://res.cloudinary.com/missionwebdev/image/upload/f_auto/v1556397355/StealthEntry/eccouncil/CHFI-cover-main.jpg"
                      data-item-url="/products.json"
                      data-item-description="This computer forensics course will give participants the necessary skills to identify an intruder’s footprints and to properly gather the necessary evidence to prosecute. Many of today’s top tools of the forensic trade will be taught during this course, including software, hardware and specialized techniques. "
                    >Add to Cart</v-btn>
                  </v-flex>
                </v-layout>
              </v-container>
