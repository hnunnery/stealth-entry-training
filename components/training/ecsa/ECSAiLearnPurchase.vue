        ...
        <v-card class="secondary--text text-xs-center py-3 elevation-12">
          <v-layout row wrap justify-center align-center>
            ...
            <v-flex xs12 lg6 px-4>
              <h2 class="display-1 secondary--text mt-4">ECSA Self-Paced (iLearn)</h2>
                ...
                <v-layout wrap justify-center align-center>
                  <v-flex xs12 sm10>
                    ...
                    <v-btn
                      ...
                      data-item-id="013"
                      data-item-name="ECSA Self-Paced (iLearn)"
                      data-item-price="1899.00"
                      data-item-image="https://res.cloudinary.com/missionwebdev/image/upload/f_auto/v1551134832/StealthEntry/eccouncil/ECSAV10-Cover.jpg"
                      data-item-url="/products.json"
                      data-item-description="EC Council Certified Security Analyst, ECSA complements the Certified Ethical Hacker, CEH certification by exploring the analytical phase of ethical hacking."
                    >Add to Cart</v-btn>
                  </v-flex>
                </v-layout>
              </v-container>
