    ...
    <v-layout justify-center mb-5>
      <v-flex xs12 lg11 xl10 class="elevation-12">
        <v-expansion-panel v-model="panel" expand>
              ...
              <v-card-text class="subheading secondary--text">
                <v-layout row wrap justify-space-around class="text-xs-left">
                  <v-flex xs12 md6 lg5 xl4>
                    ...
                    <p>
                      <span class="font-weight-bold">Exam Name:</span> ECSA
                    </p>
                    <p>
                      <span class="font-weight-bold">Number of Questions:</span> 150
                    </p>
                    <p>
                      <span class="font-weight-bold">Passing Score:</span> 70%
                    </p>
                    <p>
            ...
            <v-card>
              <v-card-text class="subheading secondary--text">
                ...
                >
                  ...
                  <v-flex xs12 md6 my-2>Module 11: Cloud Penetration Testing Methodology</v-flex>
                  <v-flex xs12 md6 my-2>Module 12: Report Writing and Post Testing Actions</v-flex>
                </v-layout>
              </v-card-text>
            </v-card>
          </v-expansion-panel-content>
          ...
          <v-expansion-panel-content>
            <template v-slot:header>
              <h4 class="primary--text headline text-xs-center">ECSA Practical</h4>
            </template>
            <v-card>
              <v-card-text>
...
ECSA (Practical) presents you with an organization and its network environment, containing multiple hosts. The internal network consists of several subnets housing various organizational units. It is made up of militarized and demilitarized zones, connected with a huge pool of database servers in a database zone. As a security precaution, and by design, all the internal resource zones are confi­gured with different subnet IPs. The militarized zone houses the domain controllers and application servers that provide application frameworks for various departments of the organization.</p>
    ...
    <ECSAiLearn :courseHome="true"/>
    <ECSAiWeek :courseHome="true"/>
    <ECSAinPerson :courseHome="true"/>
